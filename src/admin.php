...
<body>
    ...
    ?>
    <div class="m-6">
        <div class="flex flex-wrap -mx-6 p-10 align-middle justify-center">
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 adm_card">
                <a href="electeur.php">
                    <div class="flex items-center px-5 py-6 shadow-md rounded-md bg-slate-100">
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">Ajouter Electeurs</h4>
            ...
            <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0 adm_card">
                <a href="session_elect.php">
                    <div class="flex items-center px-5 py-6 shadow-md rounded-md bg-slate-100">
                        <div class="p-3 rounded-full bg-orange-600 bg-opacity-75">
                            <svg class="h-8 w-8 text-white" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                                <path d="m608 320h-64v64h22.4c5.3 0 9.6 3.6 9.6 8v16c0 4.4-4.3 8-9.6 8h-492.8c-5.3 0-9.6-3.6-9.6-8v-16c0-4.4 4.3-8 9.6-8h22.4v-64h-64c-17.7 0-32 14.3-32 32v96c0 17.7 14.3 32 32 32h576c17.7 0 32-14.3 32-32v-96c0-17.7-14.3-32-32-32zm-96 64v-319.7c0-17.9-14.5-32.3-32.3-32.3h-319.3c-17.9 0-32.4 14.5-32.4 32.3v319.7zm-300.8-182 25.5-25.3c4.2-4.2 11-4.2 15.2.1l41.3 41.6 95.2-94.4c4.2-4.2 11-4.2 15.2.1l25.3 25.5c4.2 4.2 4.2 11-.1 15.2l-128.3 127.2c-4.2 4.2-11 4.2-15.2-.1l-74.1-74.7c-4.3-4.2-4.2-11 0-15.2z" />
                            </svg>
                        </div>

                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">Ajouter une session </h4>
                            <div class="text-gray-500">electorale</div>
                        </div>
                    </div>
                </a>
            </div>

            <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0 adm_card">
                <a href="poste.php">
                    <div class="flex items-center px-5 py-6 shadow-md rounded-md bg-slate-100">
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">Ajouter poste</h4>
                            <div class="text-gray-500">Pour l'élection</div>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3  mt-5 adm_card">
                <a href="vote.php">
                    <div class="flex items-center px-5 py-6 shadow-md rounded-md bg-slate-100">
                        <div class="p-3 rounded-full bg-orange-600 bg-opacity-75">
                            <svg class="h-8 w-8 text-white" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">Election</h4>
                            <div class="text-gray-500">Creer un espace de vote</div>
                        </div>
                    </div>
                </a>
            </div>
